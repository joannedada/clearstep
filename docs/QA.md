...
This is a focused hackathon MVP. Core functionality and safety systems are complete. Infrastructure-level features, such as distributed rate limiting, authenticated preferences, and full-document content safety screening, are intentionally deferred to prioritise reliability and clarity in the demo. All deferred items are documented and can be upgraded without changes to the core system design.
